    ...
    initPage(page) {
        switch(page) {
            case 'transport': 
                ...
                break;
            case 'index': 
                if (typeof displayTicketsOnIndexPage === 'function') displayTicketsOnIndexPage();
                break;
            case 'qr': 
...
/**
 * Ініціалізація сторінки транспорту
 */
function initTransportPage() {
    // Сторінка транспорту не потребує спеціальної ініціалізації
    // Навігація працює через data-page атрибути
}
...
// ============================================
// АВТОМАТИЧНА ІНІЦІАЛІЗАЦІЯ (модифіковано для SPA)
// ============================================

// Ця ініціалізація запускається після ініціалізації Router
